...
//$modules['07_content']['shop_help']                 = 'shophelp.php?act=list_cat';商店帮助
...
// $modules['11_system']['shop_authorized']             = 'license.php?act=list_edit';//授权证书管理
// $modules['11_system']['02_payment_list']            = 'payment.php?act=list';//支付方式
// $modules['11_system']['03_shipping_list']           = 'shipping.php?act=list';//配送管理
